...
// ObservableList<String> returned by TheCustomControl.getStyleClass(). Either
// way, whichever class you choose to extend from, don't forget to import it!
...
implements Initializable
{
	...
	public TheCustomControl() throws Exception
	{
		...
		// /src/notes, goes up to /src, then down to /src/xml where it expects
		// to find TheCustomControl.fxml. As far as I can tell, all resources
		// must be in a subfolder of /src - trying to navigate through /src's
		// parent folder seems to be impossible.
	...
	// inside of FXMLLoader.load(), and nodes defined in TheCustomControl.fxml
	// are guaranteed to be non-null in here. But watch out - the method that
	// calls load() (the constructor in this example) may still see these
	// variables as null even after the line where load() is called! I have no
	// idea why.
	...
	// onAction handler expects "public void functionName(ActionEvent)", where
	// in TheCustomControl.fxml the onAction property of theButton is set as
	// "#functionName". The functionName used in this example is buttonAction.
	// 
